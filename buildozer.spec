...
source.dir = android_prober
source.include_exts = py,png,jpg,kv,html,css,otf,txt,jinja,java
source.exclude_dirs = tests, bin, examples, xml
version = 0.1
requirements = python3,plyer,pyjnius,flask==2.2.5,Werkzeug==2.3.3,kivy==2.3.0,oscpy==0.6.0,swagger-gen==0.1.2,android-prober==0.1.7
orientation = portrait
services = Tester:android_prober/platforms/android/realtime_service.py:foreground:sticky
fullscreen = 0
